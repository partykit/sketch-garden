        ...
        <div className="flex flex-col justify-start items-start gap-2">
          {starter && (
            <div className="flex flex-row justify-start items-end gap-4">
              <div className="bg-cyan-200 outline outline-2 outline-cyan-300 drop-shadow-sm rounded-lg text-4xl px-6 py-4">
          ...
          {!starter && (
            <>
              <button
                className="bg-cyan-100 outline outline-2 outline-cyan-300 hover:bg-cyan-200 rounded-lg text-4xl px-6 py-4 drop-shadow-lg hover:drop-shadow-sm"
                onClick={() => handleGetStarter()}
              >
                Get a seed!
              </button>
